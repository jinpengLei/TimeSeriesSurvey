...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.window_length = args.seq_len  # window, read about it after understanding the flow of the code...What is window size? --- temporal window size (default 24 hours * 7)
        self.original_columns = args.input_size  # the number of columns or features
